...
export interface WorkerMetadataDto {
  name?: string;
  os?: string;
}
...
> extends HttpClient<SecurityDataType> {
  ...
  /**
   * @description Initiates an AI-powered analysis of a specific security vulnerability to provide detailed insights and recommendations.
   *
   * @tags Vulnerabilities
  ...
  /**
   * @description Removes the AI analysis result from a vulnerability and resets its status to not analyzed.
   *
   * @tags Vulnerabilities
   * @name VulnerabilitiesControllerDeleteVulnerabilityAnalysis
   * @summary Delete vulnerability analysis result
   * @request DELETE:/api/vulnerabilities/{id}/analyze
   */
   ...
   * @name InternalNetworksControllerCreateInternalNetwork
   * @summary Create an internal network
   * @request POST:/api/internal-networks
   */
   ...
   *
   * @tags InternalNetworks
   * @name InternalNetworksControllerUpdateInternalNetworkById
   * @summary Update an internal network by ID
   * @request PATCH:/api/internal-networks/{id}
   */
   ...
   *
   * @tags InternalNetworks
   * @name InternalNetworksControllerDeleteInternalNetwork
   * @summary Delete an internal network
   * @request DELETE:/api/internal-networks/{id}
   */
  internalNetworksControllerDeleteInternalNetwork = (
    id: string,
    params: RequestParams = {},
  ) =>
    this.request<AppResponseSerialization, any>({
