...
const (
	...
	WorkersService_WorkerTelemetry_FullMethodName        = "/workers.WorkersService/WorkerTelemetry"
...
type WorkersServiceClient interface {
	...
	WorkerTelemetry(ctx context.Context, in *WorkerTelemetryRequest, opts ...grpc.CallOption) (*WorkerTelemetryResponse, error)
...
func (c *workersServiceClient) WorkerTelemetry(ctx context.Context, in *WorkerTelemetryRequest, opts ...grpc.CallOption) (*WorkerTelemetryResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(WorkerTelemetryResponse)
	err := c.cc.Invoke(ctx, WorkersService_WorkerTelemetry_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type WorkersServiceServer interface {
	...
	WorkerTelemetry(context.Context, *WorkerTelemetryRequest) (*WorkerTelemetryResponse, error)
...
func (UnimplementedWorkersServiceServer) WorkerTelemetry(context.Context, *WorkerTelemetryRequest) (*WorkerTelemetryResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method WorkerTelemetry not implemented")
}
...
func _WorkersService_WorkerTelemetry_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(WorkerTelemetryRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(WorkersServiceServer).WorkerTelemetry(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: WorkersService_WorkerTelemetry_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(WorkersServiceServer).WorkerTelemetry(ctx, req.(*WorkerTelemetryRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var WorkersService_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "WorkerTelemetry",
			Handler:    _WorkersService_WorkerTelemetry_Handler,
		},
		{
