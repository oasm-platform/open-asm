...
const file_connector_proto_rawDesc = "" +
	...
	"\bfindings\x18\x04 \x03(\v2\x12.connector.FindingR\bfindings\"\xf2\x05\n" +
	"\aFinding\x12\x12\n" +
	...
	"\x11modification_date\x18\x17 \x01(\v2\x1a.google.protobuf.TimestampR\x10modificationDate\x12\x15\n" +
	"\x06cea_id\x18\x19 \x03(\tR\x05ceaId\"?\n" +
	"\x04Done\x12!\n" +
...
var file_connector_proto_depIdxs = []int32{
	...
	11, // 4: connector.Finding.publication_date:type_name -> google.protobuf.Timestamp
	11, // 5: connector.Finding.modification_date:type_name -> google.protobuf.Timestamp
	0,  // 6: connector.ConnectorMessage.register:type_name -> connector.Register
	4,  // 7: connector.ConnectorMessage.result:type_name -> connector.Result
