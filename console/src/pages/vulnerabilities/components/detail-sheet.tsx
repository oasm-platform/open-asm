...
export default function DetailSheet({
  ...
  useEffect(() => {
    if (activeTab !== 'analysis' || !open) return;
        ...
        <AnimatePresence mode="wait">
          {isLoading ? (
            ...
            data && (
              ...
              >
                <TabsList className="flex w-full gap-1 bg-muted/50 p-1 rounded-lg mb-4">
                  <TabsTrigger
                    value="detail"
                ...
                <ScrollArea className="grow min-h-0 pr-2 sm:pr-4 [&>div>div]:block!">
                  ...
                  <TabsContent value="analysis" className="mt-0">
                    {data.analyzeResult ? (
                      <Markdown content={data.analyzeResult} />
                    ) : (
                      <div className="flex flex-col items-center justify-center py-12 text-center">
                        ...
                        <p className="text-sm text-muted-foreground max-w-xs mb-6">
                          AI analysis for this vulnerability has not been
                          generated yet.
                        </p>
                      </div>
                    )}
