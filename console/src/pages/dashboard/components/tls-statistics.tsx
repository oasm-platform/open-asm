...
const TlsStatistics = () => {
  ...
  const handleNavigate = () => {
    navigate('/assets?tab=tls&page=1&sortBy=not_after&sortOrder=ASC');
  };
  ...
  const items = [
    { label: 'already expired', value: data.alreadyExpired, color: 'bg-red-400' },
    { label: 'expire in a month', value: data.expireInAMonth, color: 'bg-orange-300' },
    { label: 'expire in 3 months', value: data.expireIn3Months, color: 'bg-yellow-300' },
    { label: 'won\'t expire anytime soon', value: data.wontExpireAnytimeSoon, color: 'bg-green-300' },
