  ...
  private async htmlToPdf(html: string): Promise<Buffer> {
    ...
    try {
      ...
      const footerTemplate = `
        <div style="width: 100%; padding: 6px 40px; box-sizing: border-box; display: flex; align-items: center; justify-content: flex-end; border-top: 1px solid #e2e8f0; font-family: Arial, Helvetica, sans-serif; font-size: 10px; color: #64748b;">
