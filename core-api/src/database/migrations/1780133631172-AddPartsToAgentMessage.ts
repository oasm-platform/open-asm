...
export class Migrations1780133631172 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`ALTER TABLE "agent_message_tool_calls" DROP CONSTRAINT "FK_tc_conversation"`);
        await queryRunner.query(`ALTER TABLE "agent_message_tool_calls" DROP CONSTRAINT "FK_tc_message"`);
        await queryRunner.query(`ALTER TABLE "agent_skills" DROP CONSTRAINT "FK_agent_skills_creator"`);
        await queryRunner.query(`ALTER TABLE "agent_skills" DROP CONSTRAINT "FK_agent_skills_workspace"`);
        ...
        await queryRunner.query(`ALTER TABLE "agent_conversations" DROP COLUMN "reasoningConfig"`);
        ...
        await queryRunner.query(`CREATE UNIQUE INDEX "IDX_5e5ba0e0cf217c3d50b931b59f" ON "agent_skills" ("workspaceId", "name") `);
