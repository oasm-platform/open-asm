...
export class Initialization1773452480784 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "workspace_targets" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP NOT NULL DEFAULT now(), "workspaceId" uuid, "targetId" uuid, CONSTRAINT "UQ_584f07937c6e610d12640c05442" UNIQUE ("workspaceId", "targetId"), CONSTRAINT "PK_8cc7ce852abed30e32ec51758ee" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE TABLE "templates" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP NOT NULL DEFAULT now(), "fileName" character varying NOT NULL, "path" character varying, "workspaceId" uuid, CONSTRAINT "PK_515948649ce0bbbe391de702ae5" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE TABLE "workspace_tools" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP NOT NULL DEFAULT now(), "isEnabled" boolean NOT NULL DEFAULT true, "toolId" uuid, "workspaceId" uuid, CONSTRAINT "PK_f052b0107b988bd24b14d8eb606" PRIMARY KEY ("id"))`);
        ...
        await queryRunner.query(`CREATE UNIQUE INDEX "IDX_048ab2a9f601092136b4f221c1" ON "workflows" ("filePath", "workspaceId") `);
        await queryRunner.query(`CREATE TABLE "workspace_members" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP NOT NULL DEFAULT now(), "workspaceId" uuid, "userId" uuid, CONSTRAINT "PK_22ab43ac5865cd62769121d2bc4" PRIMARY KEY ("id"))`);
        ...
        await queryRunner.query(`CREATE TABLE "asset_groups" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP NOT NULL DEFAULT now(), "name" character varying NOT NULL, "hexColor" character varying DEFAULT '#78716C', "workspaceId" uuid, CONSTRAINT "UQ_d1c6dfd6a740b46f543fe0a721c" UNIQUE ("name", "workspaceId"), CONSTRAINT "PK_1e8f37dccf890f00482ac0bb1ab" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE TABLE "assets_group_assets" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP NOT NULL DEFAULT now(), "assetGroupId" uuid, "assetId" uuid, CONSTRAINT "PK_491c815ecb7be371fd5abe9effb" PRIMARY KEY ("id"))`);
        ...
        await queryRunner.query(`CREATE TABLE "job_error_log" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP NOT NULL DEFAULT now(), "logMessage" character varying NOT NULL, "payload" character varying NOT NULL, "jobId" uuid, CONSTRAINT "PK_74e5fd465894a178ed1a0c8eb20" PRIMARY KEY ("id"))`);
        ...
        await queryRunner.query(`CREATE TABLE "asset_services" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP NOT NULL DEFAULT now(), "value" character varying NOT NULL, "port" integer NOT NULL, "assetId" uuid NOT NULL, "isErrorPage" boolean NOT NULL DEFAULT false, "screenshotPath" character varying, CONSTRAINT "UQ_693ce56f1f42942c812113c4e8f" UNIQUE ("assetId", "port"), CONSTRAINT "PK_4503b48264300e163f0b4096eeb" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE INDEX "IDX_c5b75bea43c795941c721a3ce8" ON "asset_services" ("port") `);
        await queryRunner.query(`CREATE INDEX "IDX_ff2924d9a89f955c75ce04f162" ON "asset_services" ("isErrorPage") WHERE "isErrorPage" = false`);
        await queryRunner.query(`CREATE INDEX "IDX_1533a0a0bb379a6cb6015cb941" ON "asset_services" ("createdAt") `);
        await queryRunner.query(`CREATE TABLE "asset_services_tags" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP NOT NULL DEFAULT now(), "tag" character varying NOT NULL, "assetServiceId" uuid NOT NULL, "toolId" uuid, CONSTRAINT "PK_420f7c20ba0545fa60cf1968edd" PRIMARY KEY ("id"))`);
        ...
        await queryRunner.query(`CREATE TYPE "public"."notifications_type_enum" AS ENUM('WORKSPACE_CREATED')`);
        ...
        await queryRunner.query(`CREATE TABLE "verifications" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP NOT NULL DEFAULT now(), "identifier" text NOT NULL, "value" text NOT NULL, "expiresAt" TIMESTAMP NOT NULL, CONSTRAINT "PK_2127ad1b143cf012280390b01d1" PRIMARY KEY ("id"))`);
        ...
        await queryRunner.query(`ALTER TABLE "workspace_targets" ADD CONSTRAINT "FK_94d1527f0d73cc42744bc774552" FOREIGN KEY ("workspaceId") REFERENCES "workspaces"("id") ON DELETE CASCADE ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "workspace_targets" ADD CONSTRAINT "FK_168278b842b85e1a002810d707b" FOREIGN KEY ("targetId") REFERENCES "targets"("id") ON DELETE CASCADE ON UPDATE NO ACTION`);
        ...
        await queryRunner.query(`ALTER TABLE "workspace_tools" ADD CONSTRAINT "FK_dbf87000c6e647910dae0b7ca09" FOREIGN KEY ("toolId") REFERENCES "tools"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
        ...
        await queryRunner.query(`ALTER TABLE "workers" ADD CONSTRAINT "FK_7958b532abdcf9b74629a6f297b" FOREIGN KEY ("toolId") REFERENCES "tools"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
        ...
        await queryRunner.query(`ALTER TABLE "http_responses" ADD CONSTRAINT "FK_27118f1a1f2a0b32462665b591a" FOREIGN KEY ("assetServiceId") REFERENCES "asset_services"("id") ON DELETE CASCADE ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "http_responses" ADD CONSTRAINT "FK_91b96a63361ed291c5316cfb849" FOREIGN KEY ("jobHistoryId") REFERENCES "job_histories"("id") ON DELETE CASCADE ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "ports" ADD CONSTRAINT "FK_aa01d9a6b67f27ff6e8bc9fe2cb" FOREIGN KEY ("jobHistoryId") REFERENCES "job_histories"("id") ON DELETE CASCADE ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "vulnerability_dismissals" ADD CONSTRAINT "FK_95bb810bafdd84ec1e9a8e922aa" FOREIGN KEY ("userId") REFERENCES "users"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "vulnerability_dismissals" ADD CONSTRAINT "FK_ba00c6117325d322aa2b3683b23" FOREIGN KEY ("vulnerabilityId") REFERENCES "vulnerabilities"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "vulnerabilities" ADD CONSTRAINT "FK_e9d47ee317de3073bef6897b4ae" FOREIGN KEY ("toolId") REFERENCES "tools"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
        ...
        await queryRunner.query(`ALTER TABLE "vulnerabilities" ADD CONSTRAINT "FK_f32a67d7addcf191d352c83779f" FOREIGN KEY ("jobHistoryId") REFERENCES "job_histories"("id") ON DELETE CASCADE ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "job_histories" ADD CONSTRAINT "FK_091b24d4d0feee0acb09b90aaaf" FOREIGN KEY ("workflowId") REFERENCES "workflows"("id") ON DELETE CASCADE ON UPDATE NO ACTION`);
        ...
        await queryRunner.query(`ALTER TABLE "workspaces" ADD CONSTRAINT "FK_5e888e05b7e53345908325eb5c3" FOREIGN KEY ("apiKeyId") REFERENCES "api_keys"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
        ...
        await queryRunner.query(`ALTER TABLE "assets" ADD CONSTRAINT "FK_ce4c76c97d6250442690acd57c4" FOREIGN KEY ("targetId") REFERENCES "targets"("id") ON DELETE CASCADE ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "job_error_log" ADD CONSTRAINT "FK_84a2f22f65de286bd33ec1f36ce" FOREIGN KEY ("jobId") REFERENCES "jobs"("id") ON DELETE CASCADE ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "jobs" ADD CONSTRAINT "FK_bf8d245ee6323f673d535048dca" FOREIGN KEY ("assetId") REFERENCES "assets"("id") ON DELETE CASCADE ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "jobs" ADD CONSTRAINT "FK_9a925aac2e224c4722f7ff20f5e" FOREIGN KEY ("toolId") REFERENCES "tools"("id") ON DELETE CASCADE ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "jobs" ADD CONSTRAINT "FK_9d190e9eb53feaec05fae010c7f" FOREIGN KEY ("jobHistoryId") REFERENCES "job_histories"("id") ON DELETE CASCADE ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "jobs" ADD CONSTRAINT "FK_d8a28edf869424b129df4879d5a" FOREIGN KEY ("assetServiceId") REFERENCES "asset_services"("id") ON DELETE CASCADE ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "asset_services" ADD CONSTRAINT "FK_014a31dea7a564c91b44efbd86c" FOREIGN KEY ("assetId") REFERENCES "assets"("id") ON DELETE CASCADE ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "asset_services_tags" ADD CONSTRAINT "FK_f74752b59a3fb55a09716f0596b" FOREIGN KEY ("assetServiceId") REFERENCES "asset_services"("id") ON DELETE CASCADE ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "asset_services_tags" ADD CONSTRAINT "FK_2a1732d44a4ef619467f26d63eb" FOREIGN KEY ("toolId") REFERENCES "tools"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "tools" ADD CONSTRAINT "FK_dda1871fb567020b19b49628550" FOREIGN KEY ("providerId") REFERENCES "tool_providers"("id") ON DELETE SET NULL ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "tools" ADD CONSTRAINT "FK_704dcc1f011ae1e439c08168d29" FOREIGN KEY ("apiKeyId") REFERENCES "api_keys"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "tool_providers" ADD CONSTRAINT "FK_67d937b10d56e4844e1cbe0eb3f" FOREIGN KEY ("ownerId") REFERENCES "users"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "search_histories" ADD CONSTRAINT "FK_6e5161d02385b12c2cffbb1a59a" FOREIGN KEY ("userId") REFERENCES "users"("id") ON DELETE CASCADE ON UPDATE NO ACTION`);
        ...
        await queryRunner.query(`ALTER TABLE "sessions" ADD CONSTRAINT "FK_d18286170a7fe89ae4e6306d578" FOREIGN KEY ("impersonatedById") REFERENCES "users"("id") ON DELETE CASCADE ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "mcp_permissions" ADD CONSTRAINT "FK_3aed92ab508c8e6274ffaaf5ee4" FOREIGN KEY ("ownerId") REFERENCES "users"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
        ...
        await queryRunner.query(`ALTER TABLE "notification_recipients" ADD CONSTRAINT "FK_452385a8220b8053ab65317ffa6" FOREIGN KEY ("userId") REFERENCES "users"("id") ON DELETE CASCADE ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "issue_comments" ADD CONSTRAINT "FK_b4c4200d8d9e9954e867fe967ab" FOREIGN KEY ("createdById") REFERENCES "users"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
        ...
        await queryRunner.query(`ALTER TABLE "issue_comments" ADD CONSTRAINT "FK_4146db09b8fc3116c4940209438" FOREIGN KEY ("repCommentId") REFERENCES "issue_comments"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
        ...
        await queryRunner.query(`ALTER TABLE "issues" ADD CONSTRAINT "FK_6ec638588b8a31143a6ac931ffa" FOREIGN KEY ("createdById") REFERENCES "users"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
    ...
    FROM assets a
    WHERE a."targetId" IS NOT NULL`);
        await queryRunner.query(`INSERT INTO "typeorm_metadata"("database", "schema", "table", "type", "name", "value") VALUES (DEFAULT, $1, DEFAULT, $2, $3, $4)`, ["public","VIEW","ip_assets_view","SELECT\n        a.id as \"assetId\",\n        jsonb_array_elements_text(a.\"dnsRecords\"::jsonb -> 'A') AS ip\n    FROM assets a\n    WHERE a.\"targetId\" IS NOT NULL\n\n    UNION ALL\n\n    SELECT\n        a.id as \"assetId\",\n        jsonb_array_elements_text(a.\"dnsRecords\"::jsonb -> 'AAAA') AS ip\n    FROM assets a\n    WHERE a.\"targetId\" IS NOT NULL"]);
        ...
        FROM http_responses
      `);
        await queryRunner.query(`INSERT INTO "typeorm_metadata"("database", "schema", "table", "type", "name", "value") VALUES (DEFAULT, $1, DEFAULT, $2, $3, $4)`, ["public","VIEW","status_code_asset_services_view","SELECT http_responses.status_code AS \"statusCode\",\n              http_responses.\"assetServiceId\"\n        FROM http_responses\n        UNION\n        SELECT UNNEST(chain_status_codes)::INT AS \"statusCode\",\n              http_responses.\"assetServiceId\"\n        FROM http_responses"]);
  ...
  `);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`DELETE FROM "typeorm_metadata" WHERE "type" = $1 AND "name" = $2 AND "schema" = $3`, ["VIEW","status_code_asset_services_view","public"]);
        await queryRunner.query(`DROP VIEW "status_code_asset_services_view"`);
        await queryRunner.query(`DELETE FROM "typeorm_metadata" WHERE "type" = $1 AND "name" = $2 AND "schema" = $3`, ["VIEW","ip_assets_view","public"]);
        ...
        await queryRunner.query(`ALTER TABLE "issue_comments" DROP CONSTRAINT "FK_4146db09b8fc3116c4940209438"`);
        await queryRunner.query(`ALTER TABLE "issue_comments" DROP CONSTRAINT "FK_94b28cbe4b8110d9fedcb44c489"`);
        await queryRunner.query(`ALTER TABLE "issue_comments" DROP CONSTRAINT "FK_b4c4200d8d9e9954e867fe967ab"`);
        ...
        await queryRunner.query(`ALTER TABLE "mcp_permissions" DROP CONSTRAINT "FK_3aed92ab508c8e6274ffaaf5ee4"`);
        await queryRunner.query(`ALTER TABLE "sessions" DROP CONSTRAINT "FK_d18286170a7fe89ae4e6306d578"`);
        await queryRunner.query(`ALTER TABLE "sessions" DROP CONSTRAINT "FK_57de40bc620f456c7311aa3a1e6"`);
        await queryRunner.query(`ALTER TABLE "accounts" DROP CONSTRAINT "FK_3aa23c0a6d107393e8b40e3e2a6"`);
        await queryRunner.query(`ALTER TABLE "search_histories" DROP CONSTRAINT "FK_6e5161d02385b12c2cffbb1a59a"`);
        await queryRunner.query(`ALTER TABLE "tool_providers" DROP CONSTRAINT "FK_67d937b10d56e4844e1cbe0eb3f"`);
        await queryRunner.query(`ALTER TABLE "tools" DROP CONSTRAINT "FK_704dcc1f011ae1e439c08168d29"`);
        await queryRunner.query(`ALTER TABLE "tools" DROP CONSTRAINT "FK_dda1871fb567020b19b49628550"`);
        await queryRunner.query(`ALTER TABLE "asset_services_tags" DROP CONSTRAINT "FK_2a1732d44a4ef619467f26d63eb"`);
        await queryRunner.query(`ALTER TABLE "asset_services_tags" DROP CONSTRAINT "FK_f74752b59a3fb55a09716f0596b"`);
        await queryRunner.query(`ALTER TABLE "asset_services" DROP CONSTRAINT "FK_014a31dea7a564c91b44efbd86c"`);
        await queryRunner.query(`ALTER TABLE "jobs" DROP CONSTRAINT "FK_d8a28edf869424b129df4879d5a"`);
        await queryRunner.query(`ALTER TABLE "jobs" DROP CONSTRAINT "FK_9d190e9eb53feaec05fae010c7f"`);
        await queryRunner.query(`ALTER TABLE "jobs" DROP CONSTRAINT "FK_9a925aac2e224c4722f7ff20f5e"`);
        await queryRunner.query(`ALTER TABLE "jobs" DROP CONSTRAINT "FK_bf8d245ee6323f673d535048dca"`);
        await queryRunner.query(`ALTER TABLE "job_error_log" DROP CONSTRAINT "FK_84a2f22f65de286bd33ec1f36ce"`);
        await queryRunner.query(`ALTER TABLE "assets" DROP CONSTRAINT "FK_ce4c76c97d6250442690acd57c4"`);
        ...
        await queryRunner.query(`ALTER TABLE "workspaces" DROP CONSTRAINT "FK_5e888e05b7e53345908325eb5c3"`);
        ...
        await queryRunner.query(`ALTER TABLE "job_histories" DROP CONSTRAINT "FK_091b24d4d0feee0acb09b90aaaf"`);
        await queryRunner.query(`ALTER TABLE "vulnerabilities" DROP CONSTRAINT "FK_f32a67d7addcf191d352c83779f"`);
        await queryRunner.query(`ALTER TABLE "vulnerabilities" DROP CONSTRAINT "FK_f7e68acbb73cc61c0496f67d851"`);
        await queryRunner.query(`ALTER TABLE "vulnerabilities" DROP CONSTRAINT "FK_e9d47ee317de3073bef6897b4ae"`);
        await queryRunner.query(`ALTER TABLE "vulnerability_dismissals" DROP CONSTRAINT "FK_ba00c6117325d322aa2b3683b23"`);
        await queryRunner.query(`ALTER TABLE "vulnerability_dismissals" DROP CONSTRAINT "FK_95bb810bafdd84ec1e9a8e922aa"`);
        await queryRunner.query(`ALTER TABLE "ports" DROP CONSTRAINT "FK_aa01d9a6b67f27ff6e8bc9fe2cb"`);
        await queryRunner.query(`ALTER TABLE "http_responses" DROP CONSTRAINT "FK_91b96a63361ed291c5316cfb849"`);
        await queryRunner.query(`ALTER TABLE "http_responses" DROP CONSTRAINT "FK_27118f1a1f2a0b32462665b591a"`);
        ...
        await queryRunner.query(`ALTER TABLE "workers" DROP CONSTRAINT "FK_7958b532abdcf9b74629a6f297b"`);
        ...
        await queryRunner.query(`ALTER TABLE "workspace_tools" DROP CONSTRAINT "FK_dbf87000c6e647910dae0b7ca09"`);
        await queryRunner.query(`ALTER TABLE "templates" DROP CONSTRAINT "FK_b8a4692f30364e281a01651340a"`);
        await queryRunner.query(`ALTER TABLE "workspace_targets" DROP CONSTRAINT "FK_168278b842b85e1a002810d707b"`);
        await queryRunner.query(`ALTER TABLE "workspace_targets" DROP CONSTRAINT "FK_94d1527f0d73cc42744bc774552"`);
        ...
        await queryRunner.query(`DROP INDEX "public"."IDX_1533a0a0bb379a6cb6015cb941"`);
        await queryRunner.query(`DROP INDEX "public"."IDX_ff2924d9a89f955c75ce04f162"`);
        await queryRunner.query(`DROP INDEX "public"."IDX_c5b75bea43c795941c721a3ce8"`);
        ...
        await queryRunner.query(`DROP INDEX "public"."IDX_048ab2a9f601092136b4f221c1"`);
        ...
        await queryRunner.query(`DROP INDEX "public"."IDX_27118f1a1f2a0b32462665b591"`);
        await queryRunner.query(`DROP INDEX "public"."IDX_cc7d157cf5de83c706e4b93c4f"`);
        await queryRunner.query(`DROP TABLE "http_responses"`);
        await queryRunner.query(`DROP TABLE "asset_group_workflows"`);
        await queryRunner.query(`DROP TYPE "public"."asset_group_workflows_schedule_enum"`);
