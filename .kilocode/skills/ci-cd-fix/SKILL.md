---
name: ci-cd-fix
description: Fix CI/CD pipeline issues with environment analysis, Docker optimization, and deployment validation. Use when addressing build, test, or deployment failures in CI/CD. Focus on environment analysis, Docker optimization, pipeline validation, and performance.
---
